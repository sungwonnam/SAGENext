...
VNCClientWidget::VNCClientWidget(quint64 globalappid, const QString senderIP, int display, const QString passwd, int frate, const QSettings *s, ResourceMonitor *rm, QGraphicsItem *parent, Qt::WindowFlags wflags) :
