...
static const char qt_meta_stringdata_SendThread[] = {
    "SendThread\0\0addr,port,filename\0"
    "sendFile(QHostAddress,int,QString)\0"
};
...
int SendThread::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: sendFile((*reinterpret_cast< const QHostAddress(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< const QString(*)>(_a[3]))); break;
        default: ;
        }
        _id -= 1;
    }
